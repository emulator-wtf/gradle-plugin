...
public class GradleCompatFactory {
  ...
  private static final Semver GRADLE_6_8 = new Semver("6.6",Semver.SemverType.LOOSE);
  ...
  public static GradleCompat get(Gradle gradle) {
    ...
    } else if (gradleVersion.isGreaterThanOrEqualTo(GRADLE_6_8)) {
      return new GradleCompat_6_8(gradle);
