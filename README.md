...
```groovy
plugins {
  id "wtf.emulator.gradle" version "0.16.1"
}
```
...
buildscript {
  ...
  dependencies {
    ...
    classpath "wtf.emulator:gradle-plugin:0.16.1"
  }
}
```
...
```groovy
emulatorwtf {
  // CLI version to use, defaults to 0.10.7
  version = '0.10.7'
...
|-----------------------|--------|---------------|
| JDK                   | 11     | 21            |
| Gradle                | 6.6.1  | 8.6-rc-3      |
| Android Gradle Plugin | 4.0.0  | 8.4.0-alpha05 |
