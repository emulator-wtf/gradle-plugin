...
```kotlin
plugins {
    id("wtf.emulator.gradle") version "1.8.0"
}
```
...
buildscript {
    ...
    dependencies {
        ...
        classpath("wtf.emulator:gradle-plugin:1.8.0")
    }
}
```
...
emulatorwtf {
    // CLI version to use, defaults to 1.5.1
    version.set("1.5.1")
...
| Android Gradle Plugin | 8.1.0  | 9.5.0-alpha05 |
