...
```groovy
plugins {
  id "wtf.emulator.gradle" version "1.3.0"
}
```
...
buildscript {
  ...
  dependencies {
    ...
    classpath "wtf.emulator:gradle-plugin:1.3.0"
  }
}
```
...
```groovy
emulatorwtf {
  // CLI version to use, defaults to 1.0.6
  version = '1.0.6'
...
| JDK                   | 17     | 24            |
| Gradle                | 8.0    | 9.3.1         |
| Android Gradle Plugin | 8.1.0  | 9.1.0-alpha06 |
